...
class ResponsiveButton extends Component {
  ...
  render() {
    ...
    } else if (typeof this.props.onClick === 'string' && this.props.onClick.indexOf('func:this.props.reducRouter') !== -1) { 
      onclickFunction = this.props.reducRouter[ this.props.onClick.replace('func:this.props.reducRouter', '') ];
    }
